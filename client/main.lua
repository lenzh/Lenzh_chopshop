...
function ChopVehicle()
	...
	local vehicle = GetVehiclePedIsIn( ped, false )
        exports.pNotify:SendNotification({text = "Chopping vehicle, please wait...", type = "error", timeout = 30000, layout = "centerRight", queue = "right", animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
